  ...
  describe('ParaSwapLiquiditySwapAdapter', () => {
    ...
    describe('executeOperation', () => {
      ...
      it('should correctly swap tokens using permit', async () => {
        ...
        expect(adapterDaiBalance).to.be.eq(Zero);
        expect(userADaiBalance).to.be.eq(expectedDaiAmount);
        // console.log(`userADaiBalance: ${formatEther(userADaiBalance)}`);
        ...
        console.log(`flashloanTotal: ${formatEther(flashloanTotal)}`);
        ...
        console.log(`userAEthBalance: ${formatEther(userAEthBalance)}`);
        console.log(`userAEthBalanceBefore: ${formatEther(userAEthBalanceBefore)}`);
        console.log(`amountWETHtoSwap: ${formatEther(amountWETHtoSwap)}`);
      });
